...
// import Candidates from "../pages/Candidates"; // <-- ADD THIS
...
import { showSnackbar } from "../slice/uiSlice";
import ResumeUploader from "../components/ResumeUploader";
import Candidates from "../pages/Candidates"; // Your new import
        ...
        <div className="p-10 flex-1 overflow-y-auto">
          ...
          {active === "JDs" && (
            <div className="flex items-center justify-center h-full text-gray-400">
              <p className="text-lg">Job Descriptions (JDs) module coming soon...</p>
            </div>
          )}
