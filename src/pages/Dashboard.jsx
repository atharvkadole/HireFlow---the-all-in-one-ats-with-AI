...
import Candidates from "../pages/Candidates";
import JDs from "../pages/JDs"; 
import Settings from "../pages/Settings"; // <-- ADDED THIS
        ...
        <div className="p-8 md:p-10 flex-1 overflow-y-auto">
          ...
          {active === "Dashboard" && (
            <div className="max-w-6xl mx-auto animate-fade-in">
              <Analytics />
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="h-full"><ResumeUploader /></div>
                <div className="h-full"><JDUploader /></div>
              </div>
            </div>
          )}
          ...
          {/* ADDED THE SETTINGS COMPONENT RENDER */}
          {active === "Settings" && (
